        ...
        >
            <Form ref="accessoriesTypeForm"  label-position="top" :rules="accessoriesTypeRule" :model="accessoriesType">
                ...
                <FormItem :label="L('厂商进价')" prop="purchasePrice">
                    <Input v-model="accessoriesType.purchasePrice" :maxlength="50" :minlength="2"/>
                </FormItem>
                <FormItem :label="L('配件售价')" prop="sellingPrice">
                    <Input v-model="accessoriesType.sellingPrice" :maxlength="50" :minlength="2"/>
                </FormItem>
            </Form>
            <div slot="footer">
...
<script lang="ts">
    ...
    @Component
    export default class EditAccessoriesType extends AbpBase{
        ...
        visibleChange(value:boolean){
            if(!value){
                ...
                this.getList();
                this.accessoriesType=Util.extend(true,{},this.$store.state.accessoriesType.editAccessoriesType);
            }
        }
