...
<script lang="ts">
    ...
    @Component
    export default class EditTargetConfig extends AbpBase{
        ...
        visibleChange(value:boolean){
            if(!value){
                ...
                this.targetConfig=Util.extend(true,{},this.$store.state.targetConfig.editTargetConfig);
                this.creationTime.push(new Date(this.targetConfig.from));
                this.creationTime.push(new Date(this.targetConfig.to));
            }
        }
