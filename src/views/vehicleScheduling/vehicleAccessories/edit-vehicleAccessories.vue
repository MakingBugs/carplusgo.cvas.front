...
<script lang="ts">
    ...
    @Component
    export default class EditVehicleAccessories extends AbpBase{
            ...
            (this.$refs.vehicleAccessoriesForm as any).validate(async (valid:boolean)=>{
                if(valid){
                    this.carAccessory.carAccessoryRightList = this.$store.state.carAccessoryRight.fromItemCodeList.map(x=>{
                        return {
                            id:x.id,
                            carAccessoryID:x.carAccessoryID,
                            oilID:x.oilID,
                            selected:x.selected,
                            oilType:x.oilType,
                        }
        ...
        visibleChange(value:boolean){
            if(!value){
                ...
                this.carAccessory=Util.extend(true,{},this.$store.state.carAccessory.editCarAccessory);
                this.getList();
            }
        }
        async getList(){
            ...
            this.pageCarAccessoryRightRequest.maxResultCount=10000;
            this.pageCarAccessoryRightRequest.skipCount=0;
            this.pageCarAccessoryRightRequest.carAccessoryID = this.carAccessory.id;
            ...
            this.$store.commit('carAccessoryRight/editFromItemCodeList',this.carAccessory.id);
        }
        get loading(){
