    ...
    <div>
        ...
        >
            <Form ref="additionalItemForm" :model="Form1" :label-width="100">
                <Row>
                    <Col>
                    <FormItem label="追加作业项目" style="width: 100%" prop="addoperatingItem">
...
@Component
    export default class CreateAdditionalItem extends AbpBase{
       ...
       async visibleChange(value:boolean){
            if(!value){
                ...
                this.Form1=Util.extend(true,{},this.carrepairitems); 
                this.Form1.carRepairAuto=this.carrepairitems.id;
        ...
        async getAdditionalItem(){
            ...
            await this.$store.dispatch({
                ...
                res.items.map(i=>{
                    if(i.carRepairAuto==this.carrepairitems.id){
        ...
        addfuzhi(){
            ...
            this.additionalItem.carRepairAuto=this.carrepairitems.id;
            this.additionalItem.additionalItem1=this.Form1.addoperatingItem;//追加内容
            this.additionalItem.status=20;
            this.additionalItem.serialNumber=this.addseris.length+1;//追加次数
            this.additionalItem.cuser=0;
            this.additionalItem.cdt=new Date();
