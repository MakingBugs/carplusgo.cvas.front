        ...
        >
            <Form ref="insuranceTypeForm"  label-position="top" :rules="insuranceTypeRule" :model="insuranceType">
                <FormItem :label="'名称'" prop="name">
                    <Input v-model="insuranceType.name" :maxlength="50" :minlength="2"/>
                </FormItem>
...
<script lang="ts">
    ...
    @Component
    export default class EditInsuranceType extends AbpBase{
        ...
        visibleChange(value:boolean){
            if(!value){
                ...
                this.insuranceType=Util.extend(true,{},this.$store.state.insuranceType.editInsuranceType);
            }
        }
        insuranceTypeRule={
